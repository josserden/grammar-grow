...
// import { HeaderDecor } from '@/shared/components/reusable/header-decor';
    ...
    <>
      <Wrapper alignment="start" padding="none" topInset={false}>
        <View className="relative w-full">
          {withAppVersion ? <View className="h-[134px] w-full bg-yellow-500" /> : null}

          {/*{!withoutDecor ? <HeaderDecor /> : null}*/}

          {/*{!withoutAvatar ? (*/}
          {/*  <Avatar className="absolute -bottom-1/2 left-1/2 -translate-x-1/2" />*/}
          {/*) : null}*/}
